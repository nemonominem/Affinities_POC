...
The true asymmetry is social and normative rather than genetic. Parents exercise multiple, nested forms of agency: they choose partners (which affects the child's genotype indirectly), they typically make an explicit decision to have (or to raise) children, and they then make ongoing investments of time, resources, and emotion in both partner and child. These sequential choices and continued investments create directional responsibilities, expectations, and sunk-cost dynamics that are lived asymmetrically — parents are invested in their prior choices in ways that children, who did not choose their parents, are not.

Concretely, the dimensions of parental agency include at least three distinct elements: (1) partner choice prior to conception or adoption, (2) the decision to become a parent and to enter into parental obligations, and (3) sustained investment (caregiving, financial support, socialization) over time. Each element carries normative implications (responsibility, repair, and sunk-cost reasoning) that are directional: they apply to the adult who made the choice and assumed the role, not to the child who was assigned that relationship by circumstance.

This richer account preserves the earlier point that assortative mating produces a symmetric genetic signal (see Appendix), while also making explicit why the social ranking (Children > Parents in the main text) rests on asymmetric agency and investment rather than on asymmetric genetics. It also clarifies a normative limit: although parents' investments create real reasons (practical and ethical) to sustain and prioritize some relationships, children should not be held responsible for or viewed as liable for parents' prior partner choices. Agency-as-selection and agency-as-investment are therefore separable concepts and should be treated separately in analysis and in moral reasoning.
