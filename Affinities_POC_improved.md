...
The true asymmetry is social and normative rather than genetic. Parents exercise multiple, nested forms of agency: they choose partners (which affects the child's genotype indirectly), they typically make an explicit decision to have (or to raise) children, and they then make ongoing investments of time, resources, and emotion in both partner and child. These sequential choices and continued investments create directional responsibilities, expectations, and asymmetric felt obligations — parents are invested in their prior choices in ways that children, who did not choose their parents, are not. *(The reference to "sunk-cost dynamics" is descriptive: it explains why parents psychologically experience the relationship as layered with prior commitments; it is not a normative claim that sunk costs justify sustaining any particular relationship.)*

Concretely, the dimensions of parental agency include at least three distinct elements: (1) *agency-as-selection* — partner choice prior to conception or adoption; (2) the decision to become a parent and to enter into parental obligations; and (3) *agency-as-investment* — sustained caregiving, financial support, and socialization over time. These are separable concepts with different normative implications: selection affects which genotype a child receives; investment shapes the obligations and expectations that accumulate over a lifetime.

The Children > Parents ranking therefore rests entirely on this agency asymmetry — not on any genetic directional asymmetry, which does not exist (see Appendix). Assortative mating produces a symmetric genetic signal; the boundary between the Children and Parents slots is a **pure agency distinction**.

A key normative limit follows: although parents' investments create real practical and ethical reasons to sustain relationships and bear ongoing responsibilities, children should not be held responsible for or viewed as liable for parents' prior partner choices. The directionality of obligations flows from who made the choices and assumed the role, not from the child's position in a genetic accounting.
...
*Note on structure: genetics alone does not differentiate the Children–Parents boundary — the genetic covariance is symmetric in both directions. That boundary is a pure agency distinction. Genetics only differentiates the Siblings slot, via greater non-additive variance.*

- **Partners and chosen friends** rank first because compatibility rests entirely on active *agency-as-selection*, which is the strongest available signal.
- **Children** rank second because the parent exercised real *agency-as-selection* (partner choice), indirectly filtering the child's genotype, compounded by *agency-as-investment* (sustained parenting) thereafter. The genetic baseline is symmetric — identical in both directions (child↔parent) — but the agency is asymmetric: the parent chose; the child did not. The ranking reflects this agency asymmetry, not a differential in genetic affinity.
...
*Note on register: Points 1 and 3 are primarily statistical inferences from the framework. Point 2 engages normative reasoning that goes beyond the statistics; it is an ethical argument the framework invites but does not compel, and should be evaluated on its own terms.*
...
2. **The parent–child compatibility asymmetry is one of agency, not genetics.** The underlying genetic covariance between parent and child is symmetric (identical in both directions). What differs is who exercised agency — and parental agency is multi-layered: (1) *agency-as-selection* (partner choice prior to conception or adoption), (2) the decision to become a parent and enter into parental obligations, and (3) *agency-as-investment* (sustained caregiving, financial support, and socialization over time); for full discussion see the Children: Indirect Agency section. Children exercised none of these. The directionality of normative obligations — responsibilities, duties of repair — flows from the adult who made these choices, not from the genetic accounting. These are ethical considerations, not biological ones.
